...
JerseyPublishers does not sell, rent, broker, advertise against, or transfer extension data for unrelated purposes. There is no routine human access or review because the publisher receives no app telemetry or account data.

## Security

The package uses Manifest V3, contains its executable code locally, accepts only HTTPS evidence links from imported packs, and requests only the permissions disclosed in its store listing. No software can guarantee absolute security; users should avoid putting sensitive personal information in free-form job notes.

## Children

The extension is a technical equipment-maintenance tool for adults and is not directed to children under 13. It does not knowingly collect children's personal information.

## User Choices And Deletion

Users can reset the active job inside the app, delete saved entries, clear the extension's local storage in Chrome, or uninstall the extension. Users can choose not to enter an identifier and still browse built-in reference packs.

## Limited Use Commitment

The use of information received from Chrome APIs adheres to the Chrome Web Store User Data Policy, including the Limited Use requirements. Any handling is limited to providing and improving the extension's single disclosed user-facing purpose. It is not used for personalized advertising, creditworthiness, lending, sale, or prohibited human review.

## Changes

Material policy changes will be dated here and reflected in the Chrome Web Store listing. A new package version will be submitted when behavior or permissions materially change.
